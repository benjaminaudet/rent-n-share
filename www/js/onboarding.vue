<template>
  <div id="onboarding">
    <div>
      <h1 id="title">
        <span class="small">{{steps[currentStep].smallTitle}}</span>
        <br>
        {{steps[currentStep].title}}
      </h1>
      <p>{{steps[currentStep].paragraph}}</p>
      <h1>{{steps[currentStep].paragraphTitle}}</h1>
      <div id="swipe" v-on:click="incrementCurrentStep" v-show="currentStep < 2"></div>
      <div class="button">
        <router-link
          :to="'/signup'"
      ...
      <div id="already-signed-up">
        <router-link :to="'/signin'" v-show="currentStep == 2">Already signed up?</router-link>
      </div>
    </div>
    <div id="state">
      ...
      steps: [
        {
          ...
          title: `Rent'n'Share`,
          paragraph:
            "The marketplace where you make profitable your belongings without selling it !",
          paragraphTitle: ``
        },
        {
          smallTitle: "",
